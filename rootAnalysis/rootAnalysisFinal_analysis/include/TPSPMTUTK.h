...
public:
 ...
 double denergy_qdc;
  ...
  double xpos;
  double ypos;
  double xpos_highgain;
  double ypos_highgain;
  // hit flags
  int dyhit;
  ...
  void Reset();
  void UnpackDynode(DDASRootFitHit* ddashit, TRandom3 &rng, TPSPMTUTKCalibrator &cal);
  void UnpackDynodeFit(TPSPMTUTKCalibrator &cal, std::vector<RootHitExtension> &fits, int i);
  void UnpackAnode(DDASRootFitHit* ddashit, TRandom3 &rng, TPSPMTUTKCalibrator &cal, int pix);
