...
void analyzeTree() {
  //  TFile *file = TFile::Open("/mnt/analysis/e21062/sortedData2024/betasorted/NERSC-analyzed/run-1281-sorted.root","READ");
      TFile *file = TFile::Open("/mnt/analysis/e21062/sortedData2024/betasorted/localAnalyzed/RSL/newTau-cal/run-1209-sorted.root","READ");
// Ba_2004_training_data_with_time_stamp_1st_step_modified_no_reference_to_dynode.root
  ...
  TFile* output=new TFile("output_Co_calibration_e21062-a_run1209.root","recreate");
  ...
  TTreeReaderArray<Double_t> labr_ecal(reader, "labr.ecal[16]");
