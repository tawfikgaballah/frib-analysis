...
// Mon Apr 22 19:20:40 2024 by ROOT version 6.24/06
// from TTree data/data
// found on file: /mnt/analysis/e21062/sortedData2024/betasorted/NERSC-analyzed/CorrSorted37Na-Win7/run-1420-sorted.root
//////////////////////////////////////////////////////////

#ifndef clover_selector_new_h
#define clover_selector_new_h
...
#include <TH1.h>
#include <TH2.h>
class clover_selector_new : public TSelector {
public :
...
TH2D *h1Clover33NaAll=nullptr;
  TH2D *h1Clover34NaAll=nullptr;
  TH2D *h1Clover35NaAll=nullptr;
TH2D *h1Clover33NaAll_AB=nullptr;
  TH2D *h1Clover34NaAll_AB=nullptr;
  TH2D *h1Clover35NaAll_AB=nullptr;
...
TCutG* iongates_34=nullptr;
  ...
  TCutG* iongates[4][8];
   ...
   clover_selector_new(TTree * /*tree*/ =0) { }
   virtual ~clover_selector_new() { }
 ...
 /*    } */
 /*  } */
   ClassDef(clover_selector_new,0);

};

#endif

#ifdef clover_selector_new_cxx
void clover_selector_new::Init(TTree *tree)
{
...
Bool_t clover_selector_new::Notify()
{
...
#endif // #ifdef clover_selector_new_cxx
