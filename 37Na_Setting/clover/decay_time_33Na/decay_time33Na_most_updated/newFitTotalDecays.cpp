...
void newFitTotalDecays(){
	...
	// Comment for e16032
	TFile *f = new TFile("33_37_Na_Decay_Time.root");
	TH1D *htime = (TH1D*)f->Get("/33Na/hIonDecayTime_^{33}Na");
	...
	htime->GetXaxis()->SetRangeUser(0,100);
	int npts = htime->GetNbinsX();
	...
	fitFunc->SetParameter(1, 0.693/6.19870e-05);	
	...
	fitFunc->SetParameter(2, 8.1);
	fitFunc->SetParameter(3, 12000);
