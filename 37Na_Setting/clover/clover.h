...
// Wed May  1 17:33:35 2024 by ROOT version 6.24/06
// from TTree data/data
// found on file: /mnt/analysis/e21062/sortedData2024/betasorted/NERSC-analyzed/CorrSorted37Na-Win3/run-1430-sorted.root
//////////////////////////////////////////////////////////
...
class clover : public TSelector {
public :
    // TH2D* h2CloverNaAll[4][8];
  TH2D* h2CloverNaAll_Sum;
   TH1D* h2CloverNaAll_1D;
  ...
  TH2D* PID_implantlist=nullptr;
   // TCutG* iongates[4][8];
    TFile* blobs=new TFile("./iongates_decay_CorrSorted37Na-Win3.root","Read");
  Long64_t Entry=0;
std::map<std::tuple<int, int, std::string>, std::string> nuclei = {
  ...
  const long totalEntries=1051965165;
  std::map<std::tuple<int, int, std::string>, TCutG*> iongates;
   std::map<std::tuple<int, int, std::string>, TH2D*> h2CloverNaAll;
  std::map<std::tuple<int, int, std::string>, TH1D*> hIonDecayTime;
  // TFile* blobs=new TFile("./iongates_implant_CorrSorted37Na-Win3.root","Read");
