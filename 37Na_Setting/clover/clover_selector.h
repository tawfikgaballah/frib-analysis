...
#ifndef clover_selector_h
#define clover_selector_h
...
#include <TAxis.h>
#include <vector>
#include "/projects/e21062/tg/rootAnalysis/include/TPID.h"
// #include "/projects/e21062/RSL/FinalVersionsRootAnalysis/Analytic3/include/TPID.h"
#include "/projects/e21062/tg/rootAnalysis/include/TPSPMTUTK.h"
class clover_selector : public TSelector {
public :
...
TCutG* iongates_34=nullptr;
  ...
  clover_selector(TTree * /*tree*/ =0) {

// blobs=new TFile("./../iongates.root","Read");
...
//  }
 ...
 void MakeOutput(const char *objname) {
  ...
  ClassDef(clover_selector,0);

};

#endif

#ifdef clover_selector_cxx
void clover_selector::Init(TTree *tree)
{
...
#endif // #ifdef clover_selector_cxx
