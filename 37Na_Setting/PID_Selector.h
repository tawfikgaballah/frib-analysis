...
// Mon Mar 18 09:15:32 2024 by ROOT version 6.16/00
// from TTree data/data
// found on file: /mnt/analysis/e21062/sortedData2024/betasorted/NERSC-analyzed/run-1327-sorted.root
//////////////////////////////////////////////////////////

#ifndef PID_Selector_h
#define PID_Selector_h
...
class PID_Selector : public TSelector {
public :
   TTreeReader     fReader;  //!the tree reader
  TTreeReader     fReader1;  //!the tree reader
  ...
  TH2D* LaBr3E_Vs_tdynode_offset=nullptr;
   TH2D* LaBr3_tdynode_offset_Vs_E=nullptr;
  TH1D* LaBr3_TDiff=nullptr;
  TH1D* TDynode_Offset=nullptr;
  TH2D* LaBr3E_Vs_TDiff=nullptr;
  TH2D* DyE_Vs_tdynode_offset=nullptr;
   TH2D* LaBr3_TDiff_Vs_E=nullptr;
  TH1D* Labr3_Ecal=nullptr;
  TH2D* Detector_Vs_Labr3_Ecal=nullptr;
   TH2D* Detector_Vs_TDynode_Offset_Single[16];
  TH2D* LaBr3E_Vs_tdynode_offset_Single[16];
  TH1D* LaBr3_TDiff_Single[16][16];
  TH1D* TDynode_Offset_Single[16];
  TH2D* LaBr3E_Vs_TDiff_Single[16][16];
  TH2D* DyE_Vs_tdynode_offset_single[16];
   ...
   // TTreeReaderValue<Int_t> corr_flag = {fReader, "data.corr.flag"};
   ...
   // TTreeReaderArray<Double_t> labr_ecal = {fReader, "data_cal.labr3_ecal"};
   ...
   /* TTreeReaderValue<Double_t> implantlist_de1 = {fReader, "implantlist.de1"}; */
    // TTreeReaderValue<Double_t> de2 = {fReader, "implantlist[0].de2"};
    // TTreeReaderValue<Double_t> tof = {fReader, "implantlist[0].tof"};
  ...
  //  TTreeReaderArray<std::vector<TPID>> implantlist = {fReader,"implantlist"};
   TTreeReaderValue<std::vector<TPID>> implantlist1 = {fReader,"implantlist"};
  // TTreeReaderValue<Double_t> data_cal_DE2 = {fReader,"data_cal.DE2"};
  // TTreeReaderValue<Double_t> data_cal_TOF = {fReader,"data_cal.TOF"};

   PID_Selector(TTree * /*tree*/ =0) { }
   virtual ~PID_Selector() { }
   ...
   ClassDef(PID_Selector,0);

};

#endif

#ifdef PID_Selector_cxx
void PID_Selector::Init(TTree *tree)
{
