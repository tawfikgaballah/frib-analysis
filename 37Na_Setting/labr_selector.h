...
#ifndef labr_selector_h
#define labr_selector_h
...
class labr_selector : public TSelector {
public :
  TTreeReader     fReader;  //!the tree reader
  TTree          *fChain = 0;   //!pointer to the analyzed TTree or TChain


  TH1D *h1Labr32NaAll=nullptr;
TH2D *h1Labr33NaAll=nullptr;
  TH2D *h1Labr34NaAll=nullptr;
  TH2D *h1Labr35NaAll=nullptr;
TH2D *h1Labr33NaAll_AB=nullptr;
  TH2D *h1Labr34NaAll_AB=nullptr;
  TH2D *h1Labr35NaAll_AB=nullptr;



  
  TH2D *h2Labr21NaAll=nullptr;
  TH1D *h1Labr21NAll=nullptr;
  TH1D *h1Labr24OAll=nullptr;
  TH2D *h2Labr32NaAll_AB=nullptr;
  TH2D *h2E_Vs_id_AB=nullptr;
  TH2D *h2E_Vs_id=nullptr;
  TH2D *labr_Vs_time=nullptr;
  TH2D *labr_Vs_time_ab=nullptr;
  TH2D* Detector_Vs_E_24O=nullptr;
  TH2D* Detector_Vs_E_21N=nullptr;
  TCutG* iongates_21N=nullptr;
TCutG* iongates_24O=nullptr;
  ...
  labr_selector(TTree * /*tree*/ =0) { }
  virtual ~labr_selector() { }
 ...
 void MakeOutput(const char *objname) {
  ...
  ClassDef(labr_selector,0);

};

#endif

#ifdef labr_selector_cxx
void labr_selector::Init(TTree *tree)
{
