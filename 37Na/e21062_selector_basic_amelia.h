...
// Thu Sep 19 20:35:36 2024 by ROOT version 6.24/06
// from TTree data/data
// found on file: run-1433-sorted.root
//////////////////////////////////////////////////////////

#ifndef e21062_selector_basic_amelia_h
#define e21062_selector_basic_amelia_h
...
public :
   ...
   TTreeReaderValue<Double_t> pspmthigh1_denergy_qdc = {fReader, "pspmthigh1.denergy_qdc"};
   ...
   TTreeReaderValue<Double_t> pspmthigh1_xcal = {fReader, "pspmthigh1.xcal"};
   TTreeReaderValue<Double_t> pspmthigh1_ycal = {fReader, "pspmthigh1.ycal"};
   ...
   TTreeReaderValue<Int_t> pspmthigh1_gain = {fReader, "pspmthigh1.gain"};
   ...
   TTreeReaderValue<Double_t> pspmthigh2_denergy_qdc = {fReader, "pspmthigh2.denergy_qdc"};
   ...
   TTreeReaderValue<Double_t> pspmthigh2_xcal = {fReader, "pspmthigh2.xcal"};
   TTreeReaderValue<Double_t> pspmthigh2_ycal = {fReader, "pspmthigh2.ycal"};
   ...
   TTreeReaderValue<Int_t> pspmthigh2_gain = {fReader, "pspmthigh2.gain"};
   ...
   TTreeReaderValue<Double_t> pspmtlow1_denergy_qdc = {fReader, "pspmtlow1.denergy_qdc"};
   ...
   TTreeReaderValue<Double_t> pspmtlow1_xcal = {fReader, "pspmtlow1.xcal"};
   TTreeReaderValue<Double_t> pspmtlow1_ycal = {fReader, "pspmtlow1.ycal"};
   ...
   TTreeReaderValue<Int_t> pspmtlow1_gain = {fReader, "pspmtlow1.gain"};
   ...
   TTreeReaderValue<Double_t> pspmtlow2_denergy_qdc = {fReader, "pspmtlow2.denergy_qdc"};
   ...
   TTreeReaderValue<Double_t> pspmtlow2_xcal = {fReader, "pspmtlow2.xcal"};
   TTreeReaderValue<Double_t> pspmtlow2_ycal = {fReader, "pspmtlow2.ycal"};
   ...
   TTreeReaderValue<Int_t> pspmtlow2_gain = {fReader, "pspmtlow2.gain"};
   ...
   TTreeReaderValue<Double_t> pid_xpos = {fReader, "pid.xpos"};
   TTreeReaderValue<Double_t> pid_ypos = {fReader, "pid.ypos"};
   TTreeReaderValue<Double_t> pid_ionDyEnergyLG = {fReader, "pid.ionDyEnergyLG"};
   ...
   TTreeReaderValue<Double_t> corr_dixpos = {fReader, "corr.dixpos"};
   TTreeReaderValue<Double_t> corr_diypos = {fReader, "corr.diypos"};
   TTreeReaderValue<Double_t> corr_ditime = {fReader, "corr.ditime"};
   ...
   // TTreeReaderArray<Double_t> implantlist_xpos = {fReader, "implantlist.xpos"};
   // TTreeReaderArray<Double_t> implantlist_ypos = {fReader, "implantlist.ypos"};
   // TTreeReaderArray<Double_t> implantlist_ionDyEnergyLG = {fReader, "implantlist.ionDyEnergyLG"};
  TTreeReaderValue<std::vector<TPID>> implantlist = {fReader, "implantlist"};

   e21062_selector_basic_amelia(TTree * /*tree*/ =0) { }
   virtual ~e21062_selector_basic_amelia() { }
  ...
  void MakeOutput(const char *objname) {
   ...
   ClassDef(e21062_selector_basic_amelia,0);

};

#endif

#ifdef e21062_selector_basic_amelia_cxx
void e21062_selector_basic_amelia::Init(TTree *tree)
{
...
Bool_t e21062_selector_basic_amelia::Notify()
{
...
#endif // #ifdef e21062_selector_basic_amelia_cxx
