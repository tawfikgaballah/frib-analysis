...
// Wed Sep 18 13:05:36 2024 by ROOT version 6.28/04
// from TTree data/data
// found on file: /mnt/analysis/e21062/sortedData2024/betasorted/localAnalyzed/TG/run-1418-xscintT-sipm-sorted-TG-48-10mm.root
//////////////////////////////////////////////////////////

#ifndef e21062_selector_basic_h
#define e21062_selector_basic_h
...
class e21062_selector_basic : public TSelector {
public :
...
std::map<std::tuple<int, int, std::string>, TCutG*> iongates;
   ...
   TTreeReaderValue<Double_t> pspmthigh1_xpos_highgain = {fReader, "pspmthigh1.xpos_highgain"};
   TTreeReaderValue<Double_t> pspmthigh1_ypos_highgain = {fReader, "pspmthigh1.ypos_highgain"};
   ...
   TTreeReaderValue<Double_t> pspmthigh2_xpos_highgain = {fReader, "pspmthigh2.xpos_highgain"};
   TTreeReaderValue<Double_t> pspmthigh2_ypos_highgain = {fReader, "pspmthigh2.ypos_highgain"};
   ...
   TTreeReaderValue<Double_t> pspmtlow1_xpos_highgain = {fReader, "pspmtlow1.xpos_highgain"};
   TTreeReaderValue<Double_t> pspmtlow1_ypos_highgain = {fReader, "pspmtlow1.ypos_highgain"};
   ...
   TTreeReaderValue<Double_t> pspmtlow2_xpos_highgain = {fReader, "pspmtlow2.xpos_highgain"};
   TTreeReaderValue<Double_t> pspmtlow2_ypos_highgain = {fReader, "pspmtlow2.ypos_highgain"};
   ...
   TTreeReaderArray<double> corr_radius = {fReader, "corr.radius"};
   TTreeReaderArray<double> corr_decaytime = {fReader, "corr.decaytime"};
   ...
   TTreeReaderValue<Int_t> corr_haslabr = {fReader, "corr.haslabr"};
   TTreeReaderValue<Int_t> corr_iscloveronly = {fReader, "corr.iscloveronly"};
   TTreeReaderValue<Int_t> corr_islabronly = {fReader, "corr.islabronly"};
   ...
   TTreeReaderValue<Int_t> corr_isreverse = {fReader, "corr.isreverse"};
   TTreeReaderValue<Int_t> corr_isforward = {fReader, "corr.isforward"};
  ...
  TTreeReaderValue<std::vector<TPID>> implantlist = {fReader, "implantlist"};
   ...
   e21062_selector_basic(TTree * /*tree*/ =0) { }
   virtual ~e21062_selector_basic() { }
  ...
  void MakeOutput(const char *objname) {
   ...
   ClassDef(e21062_selector_basic,0);

};

#endif

#ifdef e21062_selector_basic_cxx
void e21062_selector_basic::Init(TTree *tree)
{
...
Bool_t e21062_selector_basic::Notify()
{
...
#endif // #ifdef e21062_selector_basic_cxx
