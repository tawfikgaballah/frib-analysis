...

{
  ...
  // gSystem->Load("/projects/e21062/snl/rootanalysis/include/");
  gInterpreter->AddIncludePath("/user/e21062/HLC/ddasfitclasses/");
  gSystem->Load("/projects/e21062/snl/rootanalysis/libTParameters.so");
 
  // make the libraries
  Int_t error;
  // gROOT->ProcessLine(".L ./Selector_60_Co.C+");
  ...
  data->Add("/mnt/analysis/e21062/sortedData2024/betasorted/localAnalyzed/RSL/newTau-cal/run-1240-sorted.root");
